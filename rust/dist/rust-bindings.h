...
#define APP_LAYER_EVENT_TYPE_TRANSACTION 1

#define APP_LAYER_EVENT_TYPE_PACKET 2
...
#define RPCAUTH_BADCRED 1

#define RPCAUTH_REJECTEDCRED 2

#define RPCAUTH_BADVERF 3

#define RPCAUTH_REJECTEDVERF 4

#define RPCAUTH_TOOWEAK 5

#define RPCAUTH_INVALIDRESP 6

#define RPCAUTH_FAILED 7

#define RPCAUTH_KERB_GENERIC 8

#define RPCAUTH_TIMEEXPIRE 9

#define RPCAUTH_TKT_FILE 10

#define RPCAUTH_DECODE 11

#define RPCAUTH_NET_ADDR 12

#define RPCSEC_GSS_CREDPROBLEM 13

#define RPCSEC_GSS_CTXPROBLEM 14

#define RPCSEC_GSS_INNER_CREDPROBLEM 15

#define RPCSEC_GSS_LABEL_PROBLEM 16

#define RPCSEC_GSS_PRIVILEGE_PROBLEM 17

#define RPCSEC_GSS_UNKNOWN_MESSAGE 18
...
FileContainer *rs_nfs_gettxfiles(void *tx_ptr, uint8_t direction);
...
FileContainer *rs_smb_gettxfiles(void *tx_ptr, uint8_t direction);
...
FileContainer *rs_http2_getfiles(void *tx, uint8_t direction);
...
extern int HttpRangeAppendData(HttpRangeContainerBlock *c,
                               const unsigned char *data,
                               uint32_t data_len);
