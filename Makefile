...
ACLOCAL = ${SHELL} /home/drdave/s7-dv/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/drdave/s7-dv/missing autoconf
AUTOHEADER = ${SHELL} /home/drdave/s7-dv/missing autoheader
AUTOMAKE = ${SHELL} /home/drdave/s7-dv/missing automake-1.16
AWK = gawk
CARGO = /usr/bin/cargo
CARGO_BUILD_TARGET = 
CARGO_HOME = /home/drdave/.cargo
CBINDGEN = no
CC = gcc
...
CPP = gcc -E
CPPFLAGS = -I${srcdir}/../libhtp/   -I/usr/include/lua5.1
CXX = g++
CXXCPP = g++ -E
...
LIBOBJS = 
LIBS = -lmagic -lcap-ng -lpcap -lnet -ljansson -lpthread -lyaml -lpcre2-8  -lz -lpcap -llua5.1
...
LUA_INT8 = lua_int8
LUA_LIBS = -llua5.1
MAKEINFO = ${SHELL} /home/drdave/s7-dv/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = suricata 7.0.0-beta1
PACKAGE_TARNAME = suricata
PACKAGE_URL = 
PACKAGE_VERSION = 7.0.0-beta1
PATH_SEPARATOR = :
...
VERSION = 7.0.0-beta1
abs_builddir = /home/drdave/s7-dv
abs_srcdir = /home/drdave/s7-dv
abs_top_builddir = /home/drdave/s7-dv
abs_top_srcdir = /home/drdave/s7-dv
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
e_rundir = /var/run/
e_rustdir = /home/drdave/s7-dv/rust
...
install_sh = ${SHELL} /home/drdave/s7-dv/install-sh
